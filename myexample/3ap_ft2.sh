...
#sudo ovs-vsctl -- set Port ap1-eth2 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=100000000 queues:1=@q1 queues:2=@q2 queues:3=@q3 -- --id=@q1 create Queue other-config:min-rate=3500000 other-config:max-rate=3500000 -- --id=@q2 create Queue other-config:min-rate=1000000 other-config:max-rate=1000000 -- --id=@q3 create Queue other-config:min-rate=3500000 other-config:max-rate=3500000
#sudo ifconfig ap2-eth2 txqueuelen 100
#sudo ovs-vsctl -- set Port ap2-eth2 qos=@newqos -- --id=@newqos create QoS type=linux-htb other-config:max-rate=100000000 queues:4=@q4 queues:5=@q5 --  --id=@q4 create Queue other-config:min-rate=2500000 other-config:max-rate=2500000 -- --id=@q5 create Queue other-config:min-rate=2500000 other-config:max-rate=2500000
